...
<template>
    <GuestLayout>
        ...
        <div v-if="status" class="mb-4 text-sm font-medium text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 p-3 rounded-xl border border-emerald-200 dark:border-emerald-500/20 text-center">
            {{ status }}
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <div>
                <div class="flex items-center justify-between mb-1.5">
                    ...
                    <Link
                        ...
                        class="text-xs font-semibold text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 transition-colors"
                    >
                        Lupa sandi?
                    </Link>
                </div>
            ...
            <div class="flex items-center">
                <label class="flex items-center gap-2 cursor-pointer group">
                    <Checkbox name="remember" v-model:checked="form.remember" class="rounded border-slate-300 dark:border-slate-700 text-emerald-500 focus:ring-emerald-500" />
